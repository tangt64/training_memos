...
$TTL    7200
apple.com.              IN      SOA     node1.example.com. admin.apple.com. (
                                        2024071901      ; Serial
                                        7200            ; Refresh
                                        3600            ; Retry
                                        604800          ; Expire
...
New-NetIPAddress -IPAddress 192.168.0.1 -PrefixLength 16 -InterfaceAlias "vEthernet (MySwitch)"
New-NetNat -Name "NATNetwork" -InternalIPInterfaceAddressPrefix "192.168.0.1/16"
```

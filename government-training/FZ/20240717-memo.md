...
podman run -d --rm -p 8080:8080 quay.io/fedora/httpd-24
podman container expose                             ## 옵션표에는 있지만, 지원안함. Containerfile
podman run -d --rm -p18080:8080 -p28080:8080 --name wordpress quay.io/redhattraining/wordpress:5.3.0
...
```bash
podman pod create --publish 18080:8080 --publish 28080:80 --name pod-web-service

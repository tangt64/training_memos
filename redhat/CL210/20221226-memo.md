...
yum install ansible git yum-utils -y
...
yum install python3-pip rust cargo openssl-devel python3-devel -y
...
pip install setuptools setuptools-rust kolla-ansible docker 
...
vi globals.yaml
kolla-ansible -i all-in-one bootstrap-servers ## 무시 가능
kolla-ansible -i /root/all-in-one prechecks   ## 무시 가능
kolla-ansible -i /root/all-in-one pull        ## 무시 가능

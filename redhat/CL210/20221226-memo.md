...
vi /etc/default/grup
> GRUB_CMDLINE_LINUX="....biosdevnames=0 net.ifname=0"
grub2-mkconfig -o /etc/grub2.cfg
reboot

yum install python3-pip rust cargo openssl-devel python3-devel python3-virtualenv -y
...
> /usr/bin/python3.9
alternative --config python3
> /usr/bin/python3.9
virtualenv-3 osp    ## 임시이름

source osp/bin/activate
pip install setuptools setuptools-rust kolla-ansible==15.1.0 docker
dnf install ansible -y


## 레드햇에 인수되기전에 ansible pip 저장소를 통해서 배포.
## 더 이상 pip를 통해서 배포를 하지 않음.
## 앤서블은 PIP말고 패키지를 통해서 설치 권장.

# pip3 install setuptools
# pip3 install setuptools-rust
# pip3 install kolla-ansible         ## 신버전으로 하시는 경우 반드시 virtualenv에서 진행..몰랐어요ㅠㅠ
# pip3 install kolla-ansible==8.3.0 
# pip3 install kolla-ansible==6.1.0  ## 구버전으로 하는 경우 virtualenv사용하지 않아도 됨. 

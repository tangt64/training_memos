...
yum install python3-pip rust cargo openssl-devel python3-devel python3-virtualen python3-docker -y
...
virtualenv-3 osp          ## 임시적으로 패키지가 설치가 될 디렉터리 이름
> /root/osp

source osp/bin/activate   ## 쉘 변수 선언 및 설정
pip install setuptools setuptools-rust kolla-ansible==12.1.0 docker
pip list

...
sudo LIBGUESTFS_BACKEND=direct virt-builder --size 8G alma-8.5 -o alma-8G.raw
sudo LIBGUESTFS_BACKEND=direct virt-builder --size 8G --format qcow2 alma-8.5 -o alma-8G.qcow2
sudo LIBGUESTFS_BACKEND=direct virt-builder --size 8G --format qcow2 --root-password password:redhat alma-8.5 -o alma-8G.qcow2
...
5. virt-sysprep, virt-sparsify, virt-install 

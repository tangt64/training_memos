...
> ifIndex, <인덱스 번호>
powershell> New-NetIPAddress -IPAddress 192.168.0.1 -PrefixLength 24 -InterfaceIndex 30
...
192.168.90.130 node2.example.com node3
192.168.90.140 node2.example.com node4
EOF
```
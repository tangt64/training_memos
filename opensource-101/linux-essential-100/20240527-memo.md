...
2. --btrfs-subvolume-home: 사용자 홈 디렉터리를 서브볼륨의 구성.
...
앞으로 사용할 __표준 리눅스(LSB Linux)__ 에서는 다음과 같은 방식으로 사용자 확인을 권장.

...
httpd]# curl https://ko.wordpress.org/latest-ko_KR.tar.gz -o /var/www/html/wordpress.tar.gz
httpd]# tar xzf wordpress.tar.gz
httpd]# dnf install php php-mysqlnd -y 
...
2. 전체적인 내용 다시 재구성
3. 실제 서비스 구성 및 배포
4. 컨테이너 기본 지식(podman, kubernetes)

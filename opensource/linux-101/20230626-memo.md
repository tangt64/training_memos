...
## 선택적 보안
mount -v /dev/sdb1 /mnt/repo_test
restorecon -RFvv /mnt/repo_test/

## 재연결(remount)
mount -oremount /mnt/repo_test
umount /mnt/repo_test && mount -v /dev/sdb1 /mnt/repo_test

...
$ LIBGUESTFS_BACKEND=direct virt-builder --root-password=password:centos --arch i686 --size 10G -o /var/lib/libvirtd/images/i686-fedora.qcow2 --format qcow2 fedora-30 

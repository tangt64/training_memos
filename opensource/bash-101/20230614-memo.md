...
function setup_runtime {
	...
	logger -pnotice "$($t_logdate_lc date)podman installed by script."
...
function deploy_container {
	podman run $t_container_opts -p $t_host_port:$t_container_port -v /root/htdocs/:/var/www/html/ --name apache quay.io/centos7/httpd-24-centos7	
	podman ps 
}

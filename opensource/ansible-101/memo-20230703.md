...
collections_path="/collections:/usr/share/ansible/collections:/root/ans_wordpress/collections"
...
- 추가가 되는 주소는 http://internal.repo.example.com 으로 구성하며, gpgcheck는 하지 않는다.

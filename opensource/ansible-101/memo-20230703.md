                            ...
                            \              \
                             \              `-->requirements.yaml
                              \
                               `--> role이 설치가 될 위치
ansible-galaxy role list
links https://github.com/tangt64/training_memos/blob/main/opensource/ansible-101/materials/m4eba-haproxy-0.2.0.tar.gz
links https://github.com/tangt64/training_memos/blob/main/opensource/ansible-101/materials/serdigital64-backup-2.1.1.tar.gz

mv m4eba-haproxy-0.2.0.tar.gz serdigital64-backup-2.1.1.tar.gz /var/www/html/
```
연습문제 
---

아래 두개의 역할을 프로젝트 roles에 설치한다.
- serdigital64-backup-2.1.1.tar.gz, 이름은 backup으로 설정
- m4eba-haproxy-0.2.0.tar.gz, 이름은 haproxy으로 설정
- 설치 완료가 되면, role list로 올바르게 출력이 되는지 확이

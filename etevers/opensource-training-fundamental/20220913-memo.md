...
master #  ssh hostnamectl set-hostname node1.example.com
master #  ssh hostnamectl set-hostname node2.example.com
...
master # cat <<EOF | sudo tee /etc/yum.repos.d/kubernetes.repo
[kubernetes]
name=Kubernetes
